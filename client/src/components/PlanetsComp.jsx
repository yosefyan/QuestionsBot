...
const PlanetsComp = () => {
  return (
    <ul
      className={`stars absolute w-[40%] blur-[1rem] opacity-40 h-[70vh] ${centerItem()} animate-spin slowe justify-evenly`}
    >
      {home.lines.map((_, planetIndex) => {
        return (
          <li
            ...
            className={`border-[3rem] border-dashed shadow-xl border-orange-500/30 rotate rounded-[25%] absolute text-white/40`}
          >
